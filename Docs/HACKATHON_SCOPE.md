...
2. **No new wallet-vendor integration.** Dynamic, Para, Privy, Thirdweb all evaluated and rejected — see `Docs/CLAUDE_COMMS.md` 2026-05-03. We are locked on `@solana/wallet-adapter-react`.
