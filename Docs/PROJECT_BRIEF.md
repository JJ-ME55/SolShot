...
- **See `Docs/TELEGRAM_PLAN.md`** for the full phased plan
...
1. Check `Docs/DECISIONS.md` — the question may already be answered.
2. Check `Docs/OPEN_QUESTIONS.md` — others may have asked similar.
3. Leave a note in `Docs/CLAUDE_COMMS.md` for `main-claude`.
4. Leave a note tagged `@johnk` in `Docs/OPEN_QUESTIONS.md`.
