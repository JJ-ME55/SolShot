...
```
Read CLAUDE.md, then Docs/PROJECT_BRIEF.md, then the last 5 entries
of Docs/CLAUDE_COMMS.md. After that, leave a STATUS check-in in
...
new entries in Docs/CLAUDE_COMMS.md. Summarise in 5 bullets what's
...
```
Read Docs/CLAUDE_COMMS.md and find the most recent HANDOFF entry
...
there are blocking questions in Docs/OPEN_QUESTIONS.md tagged
...
1. Find the relevant background docs (Docs/PROJECT_BRIEF.md,
   Docs/TELEGRAM_PLAN.md, TODO.md, Docs/DECISIONS.md).
2. Map the touch surface: which files will change, which forbidden-
   zone files (per CLAUDE.md) you must NOT touch.
3. Identify any open questions in Docs/OPEN_QUESTIONS.md that block
   this work.
...
to Docs/OPEN_QUESTIONS.md as a new Q-NNN entry following the format
...
Review your recent commits on this branch. For each commit:
  - Does it match the design intent in Docs/PROJECT_BRIEF.md?
...
work this week. Include:
  ...
  - Open questions I've added to Docs/OPEN_QUESTIONS.md
