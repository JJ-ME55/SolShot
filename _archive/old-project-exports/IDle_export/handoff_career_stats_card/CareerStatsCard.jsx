    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'row', marginTop: 26 }}>
          <Stat label="TOTAL DMG"  big={fmtK(totalDamage)}    sub="HP DEALT"          bigSize={44} />
          <Spacer />
          <Stat label="K / D"      big={`${kills}/${deaths}`} sub={`${kdRatio} RATIO`} bigSize={44} />
          <Spacer />
      ...
      <div style={{
        ...
        <div style={{ fontFamily: F.mono, fontSize: 14, color: C.oliveDim, letterSpacing: '0.3em' }}>
