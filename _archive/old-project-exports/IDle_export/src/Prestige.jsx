...
const _prAsset = (p) => (window.asset ? window.asset(p) : p);
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", paddingTop: 20 }}>
            <div style={{ position: "relative", width: 220, height: 220, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 18 }}>
              {cur.id === "unranked" ? (
                ...
                <img src={_prAsset(`assets/badge-${cur.id}.png`)} style={{ width: 200, height: 200, filter: "drop-shadow(0 4px 16px rgba(0,0,0,0.6))" }} alt={cur.n} />
              )}
            </div>
          ...
          <div>
                  ...
                  <div key={t.id} onClick={() => setSelected(t.id)} style={{
                    ...
                    <div style={{ width: 48, height: 48, display: "flex", alignItems: "center", justifyContent: "center" }}>
                      {t.id === "unranked" ? (
                        ...
                        <img src={_prAsset(`assets/badge-${t.id}.png`)} style={{ width: 48, height: 48, filter: "drop-shadow(0 2px 4px rgba(0,0,0,0.5))" }} alt={t.n} />
                      )}
                    </div>
                    <div>
            ...
            {sel && sel.id !== "unranked" && (
              <div style={{
                ...
                <img src={_prAsset(`assets/badge-${sel.id}.png`)} style={{ width: 110, height: 110, filter: "drop-shadow(0 4px 10px rgba(0,0,0,0.5))" }} alt={sel.n} />
                <div>
