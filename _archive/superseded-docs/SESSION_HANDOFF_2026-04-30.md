...
| `03459ce` | Comms log entry: Phase 1 status + open asks | `Docs/internal/CLAUDE_COMMS.md` |
...
1. `Docs/internal/GROUP_CHAT_MODE.md` v0.2 (the canonical spec — design rationale)
