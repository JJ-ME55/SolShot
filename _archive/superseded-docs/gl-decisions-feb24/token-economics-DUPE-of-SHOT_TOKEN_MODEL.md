...
**Why no vesting:** Vesting contracts create a false sense of security. A solo founder with access to the upgrade authority could circumvent a vesting contract in multiple ways. Rather than implementing a mechanism that looks protective but is not, SolShot opts for transparency: the team has full discretion over their allocation, governed by public commitment rather than unenforceable smart contract constraints.
