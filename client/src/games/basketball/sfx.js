...
export function playSwish() {
    ...
    for (let i = 0; i < bufferSize; i++) {
        // Pinky-ish noise — random with slight low-pass
...
export function playBuzzer() {
    ...
    // Slight tremolo from a second osc modulating gain for "horn" texture.
...
export function playCheer() {
    ...
    // Ascending chord — three notes stacked, short staggered envelopes.
