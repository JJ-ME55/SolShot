    ...
    <>
      ...
      <div style={s.page}>
        <div style={s.content}>
          ...
          <div style={s.p}><strong>Wallet Address.</strong> When you connect your Solana wallet to SolShot, we receive your public wallet address. This is your sole identifier on the platform. We do not collect names, emails, phone numbers, or any other personal identifying information.</div>
