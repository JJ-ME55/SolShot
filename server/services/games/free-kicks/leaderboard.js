/**
 * Free-Kick Madness — leaderboard state + lead-change detection
 *
 ...
 *
 * NOTE: This module is intentionally identical in shape and
 * semantics to `server/services/games/basketball/leaderboard.js`.
 * A future refactor may promote it to a shared
 * `server/services/games/_shared/leaderboard.js` once a third arcade
 * game lands; for now duplication is the lower-risk move per the
 * arcade-new-game playbook ("minimal touches to existing
 * infrastructure").
 */
