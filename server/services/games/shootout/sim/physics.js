...
// SP-area spawn locations, clear of every cover-box AABB. Earlier
// blue spawn at (18, _, -22) was INSIDE the SE Building (X:3-20,
// Z:-25..-15) — JJ spawned looking up at the building's interior
// ceiling. New blue spawn at Z=-10 is just south of the SE Building's
// south wall, clear of both SE and NE buildings. Red at (12, _, 22)
// is in the open ground between Hollow Square (X up to 3.5) and Rect
// Structure (X from 15).
// MUST match the client's MP_SPAWN_POSITIONS exactly.
// y: 1.0 = arena floor surface (see ARENA_BOUNDS.floorY note above).
export const SPAWN_POSITIONS_BY_SLOT = Object.freeze({
    '1v1': Object.freeze([
        Object.freeze({ x: 12, y: 1.0, z:  22, yaw:  0       }), // red,  N open ground
        Object.freeze({ x: 18, y: 1.0, z: -10, yaw:  Math.PI }), // blue, +X between buildings
    ]),
    '2v2': Object.freeze([
        Object.freeze({ x: 10, y: 1.0, z:  22, yaw:  0       }), // red 1
        Object.freeze({ x: 18, y: 1.0, z: -10, yaw:  Math.PI }), // blue 1
        Object.freeze({ x: 14, y: 1.0, z:  20, yaw:  0       }), // red 2
        Object.freeze({ x: 14, y: 1.0, z: -10, yaw:  Math.PI }), // blue 2
    ]),
});
